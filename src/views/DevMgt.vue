              ...
              <template slot-scope="props">
                <el-form label-position="left" inline class="dev-table-expand" ref="form" :model="props.row">
                  ...
                  <el-form-item label="液面距离">
                    <el-input-number v-model="props.row.jizhunDistance" controls-position="right" :min="0" :precision="2" :step="0.1"></el-input-number>
                  </el-form-item>
                  <el-form-item label="对应液位">
                    <el-input-number v-model="props.row.liquidDistance" controls-position="right" :min="0" :precision="2" :step="0.1"></el-input-number>
                  </el-form-item>
                  <el-form-item label="提醒液位">
                    <el-input-number v-model="props.row.warnDistance" controls-position="right" :min="0" :precision="2" :step="0.1"></el-input-number>
                  </el-form-item>
                  <el-form-item label="停机液位">
                    <el-input-number v-model="props.row.stopDistance" controls-position="right" :min="0" :precision="2" :step="0.1"></el-input-number>
                  </el-form-item>
                  <el-form-item>
